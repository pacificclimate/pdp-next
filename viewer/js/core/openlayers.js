...
export const ol = {
  ...
  View,
  geom: { Polygon },
  // createBox is a named module export in modern OpenLayers. The legacy
  // namespace exposed it as ol.interaction.Draw.createBox(), which the
  // subsetting controller still uses.
