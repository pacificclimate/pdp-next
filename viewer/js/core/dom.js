...
export const metadataDialog = document.getElementById('metadataDialog');
export const metadataSummary = document.getElementById('metadataSummary');
export const metadataMarkdownDownload = document.getElementById('metadataMarkdownDownload');
